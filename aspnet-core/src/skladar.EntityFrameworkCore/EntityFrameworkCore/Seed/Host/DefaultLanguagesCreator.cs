...
namespace skladar.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly skladarDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = skladarConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(skladarDbContext context)
        {
            _context = context;
        }
