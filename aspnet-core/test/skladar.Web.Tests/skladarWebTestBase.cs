...
namespace skladar.Web.Tests
{
    public abstract class skladarWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static skladarWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(skladarWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<skladarDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<skladarDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<skladarDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<skladarDbContext, Task<T>> func)
        {
            T result;
