...
import Translator from 'react-planner/es/translator/translator';
import Catalog from 'react-planner/es/catalog/catalog';
import actions from 'react-planner/es/actions/export';
import {objectsMap} from 'react-planner/es/utils/objects-utils';
import {
    ToolbarComponents,
    Content,
    SidebarComponents,
    FooterBarComponents
} from 'react-planner/es/components/export';
import {VERSION} from 'react-planner/es/version';
import 'react-planner/es/styles/export';
...
class ReactPlanner extends Component {
    ...
    componentWillMount() {
        ...
        let {projectActions, catalog, stateExtractor, plugins, store} = this.props;
...
function mapStateToProps(reduxState) {
    return {
        state: reduxState['react-planner'],
    }
}
